...
<details><summary><b>[16] NotoSansNagMundari-Regular.ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Check Google Fonts glyph coverage. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/glyph_coverage">com.google.fonts/check/glyph_coverage</a>)</summary><div>
...
* 🔥 **FAIL** OS/2.fsSelection bit 7 (USE_TYPO_METRICS) wasNOT set in the following fonts: ['fonts/NotoSansNagMundari/googlefonts/ttf/NotoSansNagMundari-Regular.ttf']. [code: missing-os2-fsselection-bit7]
...
* 🔥 **FAIL** .notdef glyphs were found when attempting to render Noto Sans Nag Mundari [code: render-own-name]
...
* ⚠ **WARN** Font is monospaced but 1 glyphs (50.00%) have a different width. You should check the widths of: ['space'] [code: mono-outliers]
